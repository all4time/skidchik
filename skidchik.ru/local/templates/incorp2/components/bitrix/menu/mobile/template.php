...
foreach($arResult as $arItem):?>
	...
	<?if ($arItem["IS_PARENT"]):?>
		...
		<?if ($arItem["DEPTH_LEVEL"] == 1):?>
			<li><a href="<?=$arItem["LINK"]?>" class="parent <?if ($arItem["SELECTED"]):?>active<?endif?>"><?=$arItem["TEXT"]?></a>
				<ul>
				<li><a href="#" class="back"><?=GetMessage("BACK")?></a></li>
				<li class="parent_head"><a href="<?=$arItem["LINK"]?>"><?=$arItem["TEXT"]?></a></li>
