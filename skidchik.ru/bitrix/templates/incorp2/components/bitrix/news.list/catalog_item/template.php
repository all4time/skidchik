        ...
        <div class="item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
            <div>
                ...
                <div class="description">
                    ...
                    <span class="price"><?if($arItem['PROPERTIES']['PRICE']['VALUE']):?><?=number_format($arItem['PROPERTIES']['PRICE']['VALUE'], 0, ',', ' ');?> <?=CIncorp2::getCurrency();?><?endif;?> <?if($arItem['PROPERTIES']['OLD_PRICE']['VALUE']):?><span class="old_price"><?=number_format($arItem['PROPERTIES']['OLD_PRICE']['VALUE'], 0, ',', ' ');?> <?=CIncorp2::getCurrency();?></span><?endif;?></span>
                </div>
            </div>
        </div>
        <?endforeach;?>
