...
foreach($arResult as $arItem):?>
	...
	<li><a href="<?=$arItem["LINK"]?>" <?if ($arItem["SELECTED"]):?>class="active"<?endif?>><?=$arItem["TEXT"]?><i class="fa fa-caret-down" aria-hidden="true"></i></a>
				<ul>
		<?else:?>
			<li><a href="<?=$arItem["LINK"]?>" class="parent"><?=$arItem["TEXT"]?><i class="fa fa-caret-right" aria-hidden="true"></i></a>
				<ul>
		<?endif?>
