...
<div class="papers blog blog_in blog_papers">
	...
	?>
	<a href="<?=$rss_url?>" title="rss" target="_self"><img alt="RSS" src="<?=$templateFolder?>/images/feed-icon-16x16.png" border="0" align="right" /></a>
	<?endif?>

	<?$APPLICATION->ShowViewContent('nav');?>
	<?$APPLICATION->IncludeComponent("bitrix:search.tags.cloud", "article", Array(
		"CACHE_TIME" => "3600",	
		"CACHE_TYPE" => "A",	
		"CHECK_DATES" => "N",	
		"FILTER_NAME" => "",
		...
		"arrFILTER_iblock_vbf_incorp2_content" => array(	
			0 => CCache::$arIBlocks[SITE_ID]["vbf_incorp2_content"]["vbf_incorp2_blog"][0],
		)
	),
	false
);?>
